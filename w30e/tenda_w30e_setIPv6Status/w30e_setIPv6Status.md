...
httpd in directory `/bin` has a stack overflow vulnerability. The vulnerability occurrs in the `set_wan_status` function, which can be accessed via the URL `setIPv6Status`
